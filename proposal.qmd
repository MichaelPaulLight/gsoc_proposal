...
-   I have a solid understanding of the theory behind prior, retrodictive, and predictive checks in the Bayesian workflow, and experience using bayesplot, tidybayes, ggdist, marginaleffects, and vmc to analyze/visualize models.
...
I'm available through the entire GSOC period, and plan on working on this project at least 20 hours each week. I'll be happy to work with the Stan team to adjust the total working hours as needed.
...
I hope to continue contributing to the broader Stan project as I figure out the next steps in my professional or academic life.
